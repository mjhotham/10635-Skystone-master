...
@TeleOp(name = "Red 2 Stone Side by Side Auto")
...
//        lift.slideTargetIN = 0;
        ...
        drive.followTrajectory(drive.trajectoryBuilder().back(15).lineTo(new Vector2d(drive.getPoseEstimate().getX() + 20, drive.getPoseEstimate().getY() + 10)).build());
