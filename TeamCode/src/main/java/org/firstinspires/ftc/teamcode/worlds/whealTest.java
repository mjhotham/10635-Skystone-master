...
@TeleOp
public class whealTest extends LinearOpMode {
...
//            LoopTimer.reset();
            ...
            //temporary because I want to do fun stuff...
//            if (gamepad2.left_bumper) {
...
//
            ...
            if (!gamepad2.start) {
                ...
                if (gamepad2.a)
                    if (poseA == null)
                        ...
                        drive.followTrajectory(drive.trajectoryBuilder().lineTo(new Vector2d(poseA.getX(), poseA.getY())).build());

                if (gamepad2.b)
                    if (poseB == null)
                        poseB = poseEstimate;
                    else
                        drive.followTrajectory(drive.trajectoryBuilder().lineTo(new Vector2d(poseB.getX(), poseB.getY())).build());
            }
            ...
            packet.put("gyro", drive.getExternalHeading());
