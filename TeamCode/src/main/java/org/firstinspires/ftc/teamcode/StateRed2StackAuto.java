...
public class StateRed2StackAuto extends LinearOpMode {
    ...
    Pose2d getWhateverItIsCalled = new Pose2d(-33, -47, Math.PI);          // the foundation
    ...
    public void runOpMode() throws InterruptedException {      // Red stacking Auto?
        ...
        drive.followTrajectory(drive.trajectoryBuilder().reverse().splineTo(underBridge).splineTo(getWhateverItIsCalled).back(3).build());   //all in reverse
